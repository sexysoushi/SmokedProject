...
const QMetaObject ParticleSystem::staticMetaObject = {
    { &Object3D::staticMetaObject, qt_meta_stringdata_ParticleSystem.data,
      qt_meta_data_ParticleSystem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ParticleSystem::qt_metacast(const char *_clname)
{
    ...
    return Object3D::qt_metacast(_clname);
}

int ParticleSystem::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = Object3D::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
